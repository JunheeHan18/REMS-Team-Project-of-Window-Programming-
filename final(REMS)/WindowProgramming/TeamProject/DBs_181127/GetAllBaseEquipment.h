// GetAllBaseEquipment.h : CGetAllBaseEquipment의 선언입니다.

#pragma once

// 코드 생성 위치 2018년 12월 3일 월요일, 오후 9:35

class CGetAllBaseEquipment : public CRecordset
{
public:
	CGetAllBaseEquipment(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CGetAllBaseEquipment)
